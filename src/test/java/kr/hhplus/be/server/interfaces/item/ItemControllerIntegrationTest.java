...
class ItemControllerIntegrationTest {
    ...
    @Test
    void 인기_상품_통계_저장을_요청() {

        // given
        ItemRequest.PopularItemStatisticsRequest request = new ItemRequest.PopularItemStatisticsRequest(1L, 1L, 2);
    ...
    @ParameterizedTest
    @ValueSource(longs = {-100L, -10L, -3L, -2L, -1L, 0L})
    void 양수가_아닌_주문식별자로_인기상품통계저장(long orderId) {

        // given
        ItemRequest.PopularItemStatisticsRequest request = new ItemRequest.PopularItemStatisticsRequest(orderId, 1L, 1L);
    ...
    @ParameterizedTest
    @ValueSource(longs = {-100L, -10L, -3L, -2L, -1L, 0L})
    void 양수가_아닌_유저식별자로_인기상품통계저장(long userId) {

        // given
        ItemRequest.PopularItemStatisticsRequest request = new ItemRequest.PopularItemStatisticsRequest(1L, userId, 1L);
    ...
    @ParameterizedTest
    @ValueSource(longs = {-100L, -10L, -3L, -2L, -1L, 0L})
    void 양수가_아닌_상품식별자로_인기상품통계저장(long itemId) {

        // given
        ItemRequest.PopularItemStatisticsRequest request = new ItemRequest.PopularItemStatisticsRequest(1L, 1L, itemId);
