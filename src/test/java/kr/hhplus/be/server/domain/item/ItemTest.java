...
class ItemTest {
    ...
    class 상품_생성 {
        ...
        void 상품명이_비어있으면_IllegalArgumentException_발생(String itemName) {
            ...
            //when, then
            assertThatThrownBy(() -> Item.of(1L, itemName, Stock.of(1000), 100))
        ...
        void 재고가_null_이면_IllegalArgumentException_발생(Stock stock) {
            ...
            //when, then
            assertThatThrownBy(() -> Item.of(1L, "상품명", stock, 100))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void 가격이_음수이면_IllegalArgumentException_발생(int price) {
            ...
            //when, then
            assertThatThrownBy(() -> Item.of(1L, "상품명", Stock.of(1000), price))
                    .isInstanceOf(IllegalArgumentException.class)
