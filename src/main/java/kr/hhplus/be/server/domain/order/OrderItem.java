...
public class OrderItem {
    ...
    public static OrderItem of(Order order, Item item, int count) {
        ...
        return new OrderItem(null, order.getId(), item.getId(), item.getItemName(), item.getPrice(), count);
    }

    public OrderItem(Long id, long orderId, long itemId, String itemName, int sellPrice, int count) {
    ...
    public boolean equals(Object o) {
        ...
        return orderId == orderItem.orderId && itemId == orderItem.itemId && sellPrice == orderItem.sellPrice && count == orderItem.count && Objects.equals(id, orderItem.id) && Objects.equals(itemName, orderItem.itemName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, orderId, itemId, itemName, sellPrice, count);
    }
